...
export default function Hero() {
    return (
        <div className="flex flex-col items-center">
            <h1 className="text-text dark:text-text-dark text-6xl text-bold capitalize text-center">Search & <span className="text-primary dark:text-primary-dark">Discover</span><br /> your next book</h1>
