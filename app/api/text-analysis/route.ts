...
export async function GET(request: NextRequest) {
    ...
    try {
        // return Response.json("Test summary test test")
        ...
        - Avoids minor and insignificant details.
        ...
        Please summarize the book in a style similar to the example and in no way can you exceed 150 words.
        ...
        You are an expert in summarizing book content.
        ...
        - Focus on enhancing the clarity and flow of the summary.
        ...
        - Maintain a concise summary that captures the essence of the book in no more than 150 words.
    
        Example of a refined summary:
        Original: "The protagonist, Sarah, struggles with her place in society."
        Refined: "In a rigid society, Sarah grapples with her identity, reflecting themes of individualism and social conformity."
